...
<head>
    ...
    <title>Clubspectre | Teacher's Report Attendance</title>
...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td>
                    Name: {{ $report['teacher']->user->name }} <br>
                </td>
            </tr>
            <tr>
                <td>
                    Email: {{ $report['teacher']->user->email }} <br>
                </td>
            </tr>
            <tr>
                <td>
                    Gender: {{ $report['teacher']->gender }} <br>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            <tr class="student">
                <td class="name-col">{{$report['teacher']->user->name}}</td>
                @php
